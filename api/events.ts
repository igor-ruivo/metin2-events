...
import { formatScheduleForDiscord, getCurrentMonthSchedule } from "../src/scraper";
...
interface VercelRequest {
  ...
  method: string;
  on: (event: string, callback: (chunk?: any) => void) => void; // porque vamos ler o body manualmente
}
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const interaction: DiscordInteraction = JSON.parse(stringifiedBody);
